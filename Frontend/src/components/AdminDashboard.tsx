...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      try {
        const response = await fetch("https://adrap-2.onrender.com/api/subjects");
    ...
    const updateBatchAndSection = async () => {
      try {
        const response = await fetch(
          "https://adrap-2.onrender.com/api/settings/batchsection",
          {
            method: "POST",
  ...
  const handleDeleteSubject = async (subjectToDelete: {
    ...
    try {
      ...
      const response = await fetch(
        `https://adrap-2.onrender.com/api/subjects/${subjectToRemove.id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const handleResetSubjects = async () => {
    if (
      ...
      try {
        const response = await fetch(
          "https://adrap-2.onrender.com/api/subjects/reset",
          {
            method: "POST",
          }
        );
